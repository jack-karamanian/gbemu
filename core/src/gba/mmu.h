...
class Mmu {
  ...
  */
  ...
  static constexpr std::array<u8, 48> bios_vblank_intr_wait = {
      0x03, 0x00, 0x2d, 0xe9, 0x03, 0x14, 0xa0, 0xe3, 0x02, 0x19, 0x81, 0xe2,
      0x08, 0x10, 0x41, 0xe2, 0x00, 0x00, 0x02, 0xef, 0xb0, 0x00, 0xd1, 0xe1,
      0x01, 0x00, 0x10, 0xe3, 0xfb, 0xff, 0xff, 0x0a, 0x01, 0x00, 0xc0, 0xe3,
      0x00, 0x00, 0x81, 0xe5, 0x03, 0x00, 0xbd, 0xe8, 0x0e, 0xf0, 0xb0, 0xe1};

  static constexpr u32 VBlankIntrWaitAddr = 0x128 + 28;
  ...
  Mmu() {
    ...
    std::copy(bios_vblank_intr_wait.begin(), bios_vblank_intr_wait.end(),
              m_bios.begin() + VBlankIntrWaitAddr);
  }

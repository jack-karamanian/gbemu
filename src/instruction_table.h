...
constexpr std::array<std::string_view, 256> instruction_names = {
    ...
    "JP NC,a16",  "INVALID",     "CALL NC,a16", "PUSH DE",     "SUB d8",
    "RST 10H",    "RET C",       "RETI",        "JP C,a16",    "INVALID",
    "CALL C,a16", "INVALID",     "SBC A,d8",    "RST 18H",     "LDH (a8),A",
    "POP HL",     "LD (C),A",    "INVALID",     "INVALID",     "PUSH HL",
    "AND d8",     "RST 20H",     "ADD SP,r8",   "JP (HL)",     "LD (a16),A",
    "INVALID",    "INVALID",     "INVALID",     "XOR d8",      "RST 28H",
    "LDH A,(a8)", "POP AF",      "LD A,(C)",    "DI",          "INVALID",
    "PUSH AF",    "OR d8",       "RST 30H",     "LD HL,SP+r8", "LD SP,HL",
    "LD A,(a16)", "EI",          "INVALID",     "INVALID",     "CP d8",
    "RST 38H",
};

constexpr std::array<std::string_view, 256> cb_instruction_names = {
